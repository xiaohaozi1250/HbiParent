...
public class OmHeadersController extends BaseController {
    ...
    @Autowired
    private IOmLinesService serviceLine;
    ...
    @ResponseBody
    public ResponseData queryLine(OmLines dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
                                  @RequestParam(defaultValue = DEFAULT_PAGE_SIZE) int pageSize, HttpServletRequest request) {
        IRequest requestContext = createRequestContext(request);
    ...
    @ResponseBody
    public ResponseData updateLine(@RequestBody List<OmLines> dto, BindingResult result, HttpServletRequest request) {
    ...
    @ResponseBody
    public ResponseData deleteLine(HttpServletRequest request, @RequestBody List<OmLines> dto) {
